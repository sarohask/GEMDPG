...
void HitsAnalysis::Loop()
	{
   	...
   	f = new TFile("HitsAnalysis_e+_60_40_ArCO2.root", "RECREATE");
  	...
  	3.981072e-5, 4.466836e-5, 5.011872e-5, 5.623413e-5, 6.309573e-5, 7.079458e-5, 7.943282e-5, 8.91251e-5, 1.0e-4,
   	...
   	TH1D* h_PrimaryEnergy = new TH1D("h_PrimaryEnergy"," Primary Energy of Positrons ", 240, binEdge);
    h_PrimaryEnergy->GetXaxis()->SetTitle("Energy (MeV)");
    h_PrimaryEnergy->GetYaxis()->SetTitle("Number of Events"); 
   	
  	TH1D* h_PositronSensitivity = new TH1D("h_PositronSensitivity"," Positron Sensitivity vs Kinetic Energy", 240, binEdge);
